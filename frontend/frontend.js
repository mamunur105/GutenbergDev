...
const cUp = () => document.addEventListener("DOMContentLoaded", event => {
  const el = document.querySelector('.countvalue'); // Start counting, do this on DOM ready or with Waypoints.
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _counterup_Counter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./counterup/Counter */ "./src/counterup/Counter.js");

Object(_counterup_Counter__WEBPACK_IMPORTED_MODULE_0__["default"])();
