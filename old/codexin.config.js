...
module.exports = {
	...
	projectURL     : 'http://develop.test/',              // Local project URL of your already running WordPress site.
	...
	blockJSSRC		  : './src/index.js',
	blockJSDestination: './build/',                // Path to place the compiled admin JS file.
	jsBlockFile: 'index',                // Path to place the compiled admin JS file.
	// JS Custom options.
